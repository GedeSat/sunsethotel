 <nav class="w-full fixed top-0 left-0 z-50 bg-black/40 backdrop-blur-xl border-b border-orange-500/40">
        <div class="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
            ...
            <div class="hidden md:flex space-x-10 font-semibold">
                ...
                <a href="#facilities" class="text-white hover:text-orange-300 px-4 py-2">About us</a>
...
<div class="relative">
    ...
    <!-- DROPDOWN -->
    <div id="dropdownMenu"
         class="absolute right-0 mt-2 bg-white shadow-lg rounded-lg py-2 w-40 hidden">
