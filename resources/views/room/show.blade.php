...
@php
    // gallery optional (JSON), fallback ke image utama
...
<section class="pt-28 pb-20 bg-gradient-to-b from-gray-50 via-white to-white overflow-hidden">
    <div class="max-w-7xl mx-auto px-6">
        ...
        <div class="text-center mb-14" data-aos="fade-up">
            <span class="px-4 py-1.5 bg-orange-100 text-orange-600 rounded-full text-xs font-bold uppercase tracking-widest mb-4 inline-block">
                {{ $room->type }}
            </span>
